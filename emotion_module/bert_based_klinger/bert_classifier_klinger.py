...
# Used this file in compliance with the license
#
...
- Storing the Emotion predictions and the represenations 
"""
...
## Required parameters
flags.DEFINE_string("emotion_file", "data/emotions_new.txt",
...
flags.DEFINE_string("vocab_file", "/bert/cased_L-12_H-768_A-12/vocab.txt",
                    "The vocabulary file that the BERT model was trained on.")

flags.DEFINE_string(
    "output_dir", "output_kling_bin_bal",
    "The output directory where the model checkpoints will be written.")

flags.DEFINE_string("test_fname", "train_ag_dg_hyp.tsv", "The name of the test file.")
flags.DEFINE_string("train_fname", "kling_bal_train_bin.tsv",
                    "The name of the training file.")
flags.DEFINE_string("dev_fname", "train_ag_dg_hyp.tsv", "The name of the dev file.")
...
flags.DEFINE_string(
    "init_checkpoint", "bert/cased_L-12_H-768_A-12/bert_model.ckpt.index",
...
def main(_):
  ...
  if FLAGS.do_predict:
    ...
    preds_file = open(FLAGS.test_fname+'_new_k_bal_numb_predictions_bin.csv', 'w')
    ...
    with open(FLAGS.test_fname + '_new_k_bal_bin.pickle', 'wb') as handle:
